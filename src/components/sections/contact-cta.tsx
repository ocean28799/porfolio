      ...
      <div className="text-center space-y-6 sm:space-y-8">
        ...
        <div className="grid grid-cols-3 gap-3 sm:gap-6 max-w-2xl mx-auto">
          {SOCIAL_PROOF.map((item, index) => (
            ...
            >
              <Card className="p-3 sm:p-4 text-center bg-white dark:bg-gradient-to-br dark:from-slate-900/50 dark:via-slate-800/30 dark:to-slate-900/50 border-slate-200 dark:border-slate-700/50 hover:border-emerald-500/50 dark:hover:border-slate-600/50 transition-all shadow-sm dark:shadow-none">
                ...
                <div className="text-xs sm:text-sm text-slate-500 dark:text-slate-400">{item.label}</div>
              </Card>
            </motion.div>
          ))}
        </div>
